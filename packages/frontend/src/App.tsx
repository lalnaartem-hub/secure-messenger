...
export function App() {
  ...
  if (!accessToken) {
    return (
      <div className="h-full flex flex-col items-center justify-center bg-[#070709] relative overflow-hidden select-none">
        ...
        <div className="bg-zinc-950/60 border border-zinc-800/80 w-full max-w-md p-8 rounded-3xl shadow-2xl backdrop-blur-xl z-10 flex flex-col items-center animate-in fade-in zoom-in-95 duration-500">
          
          {/* Animated Shield/Lock Icon */}
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-indigo-500 to-purple-600 flex items-center justify-center shadow-lg shadow-indigo-500/20 mb-6 relative">
          ...
          <p className="text-sm text-zinc-400 text-center mb-8 max-w-xs leading-relaxed">
            Ваши приватные ключи генерируются на устройстве и никогда не отправляются на сервер.
          </p>
          ...
          <div className="w-full flex flex-col gap-3.5">
            <a
              ...
              className="w-full py-3.5 px-4 bg-zinc-900 hover:bg-zinc-855 border border-zinc-800 rounded-xl font-semibold text-sm text-zinc-100 flex items-center justify-center gap-3 transition-all duration-300 transform active:scale-[0.98] shadow-lg shadow-black/20 hover:border-zinc-700"
            >
              {/* Google SVG */}
  ...
  return (
    <div className="h-full flex bg-[#070709] select-none text-zinc-100 overflow-hidden">
      {/* Sidebar Area */}
        ...
        <div className="p-4 border-t border-zinc-900 bg-zinc-950/80 flex items-center justify-between">
          <div className="flex items-center gap-2.5 min-w-0">
            <div className="relative">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-emerald-500 to-teal-600 text-white flex items-center justify-center font-bold text-xs shadow-lg shadow-emerald-500/10">
